...
namespace VM
{
    ...
    public static class VMOS_String
    {
        ...
        private static String StrObj(Emulator vm, int strId)
        {
            String stringObj;
        ...
        public static void AllocNew(Emulator vm)
        {
            ...
            strId++;
            String sourceObj = StrObj(vm, sourceStrId);

            vm.mStrings.Add(strId, new String(sourceObj.mString));
            vm.StackPush(strId);
        }
        ...
        public static void Append(Emulator vm)
        {
            ...
            int strId = vm.StackPop();
            String strObj = StrObj(vm, strId);
            String strAppendObj = StrObj(vm, strAppend);
